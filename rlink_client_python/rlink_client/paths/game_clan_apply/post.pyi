...
request_query_clan_list_name = api_client.QueryParameter(
    name="clanList_name",
    style=api_client.ParameterStyle.FORM,
    schema=ClanListNameSchema,
    required=True,
    explode=True,
)
...
class GameClanApply(BaseApi):
    ...
    def game_clan_apply(
        ...
        return self._game_clan_apply_oapg(
