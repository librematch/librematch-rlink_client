...
request_query_platform_ids = api_client.QueryParameter(
    name="platformIDs",
    style=api_client.ParameterStyle.FORM,
    schema=PlatformIDsSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_account_find_profiles_by_platform_id_oapg(
        self,
...
class GameAccountFindProfilesByPlatformId(BaseApi):
    ...
    def game_account_find_profiles_by_platform_id(
        ...
        return self._game_account_find_profiles_by_platform_id_oapg(
