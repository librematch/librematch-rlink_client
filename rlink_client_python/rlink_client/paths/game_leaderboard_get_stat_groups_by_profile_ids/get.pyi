...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_leaderboard_get_stat_groups_by_profile_ids_oapg(
        self,
...
class GameLeaderboardGetStatGroupsByProfileIds(BaseApi):
    ...
    def game_leaderboard_get_stat_groups_by_profile_ids(
        ...
        return self._game_leaderboard_get_stat_groups_by_profile_ids_oapg(
