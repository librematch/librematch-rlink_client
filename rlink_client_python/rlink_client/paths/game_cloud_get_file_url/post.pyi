...
request_query_names = api_client.QueryParameter(
    name="names",
    style=api_client.ParameterStyle.FORM,
    schema=NamesSchema,
    required=True,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_cloud_get_file_url_post_oapg(
        self,
...
class GameCloudGetFileUrlPost(BaseApi):
    ...
    def game_cloud_get_file_url_post(
        ...
        return self._game_cloud_get_file_url_post_oapg(
