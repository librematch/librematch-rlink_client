...
request_query_meta_data = api_client.QueryParameter(
    name="metaData",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_account_set_avatar_metadata_oapg(
        self,
...
class GameAccountSetAvatarMetadata(BaseApi):
    ...
    def game_account_set_avatar_metadata(
        ...
        return self._game_account_set_avatar_metadata_oapg(
