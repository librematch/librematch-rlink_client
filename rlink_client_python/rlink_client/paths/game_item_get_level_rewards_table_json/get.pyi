...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_item_get_level_rewards_table_json_oapg(
        self,
...
class GameItemGetLevelRewardsTableJson(BaseApi):
    ...
    def game_item_get_level_rewards_table_json(
        ...
        return self._game_item_get_level_rewards_table_json_oapg(
