...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_leaderboard_get_recent_match_history_post_oapg(
        self,
...
class GameLeaderboardGetRecentMatchHistoryPost(BaseApi):
    ...
    def game_leaderboard_get_recent_match_history_post(
        ...
        return self._game_leaderboard_get_recent_match_history_post_oapg(
