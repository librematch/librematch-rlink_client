...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_leaderboard_get_recent_match_history_get_oapg(
        self,
...
class GameLeaderboardGetRecentMatchHistoryGet(BaseApi):
    ...
    def game_leaderboard_get_recent_match_history_get(
        ...
        return self._game_leaderboard_get_recent_match_history_get_oapg(
