...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_chat_delete_offline_message_oapg(
        self,
...
class GameChatDeleteOfflineMessage(BaseApi):
    ...
    def game_chat_delete_offline_message(
        ...
        return self._game_chat_delete_offline_message_oapg(
