...
SaleVersionSchema = schemas.IntSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'saleVersion': typing.Union[SaleVersionSchema, decimal.Decimal, int, ],
    }
)
...
request_query_sale_version = api_client.QueryParameter(
    name="saleVersion",
    style=api_client.ParameterStyle.FORM,
    schema=SaleVersionSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_item_get_item_prices_oapg(
        self,
...
class GameItemGetItemPrices(BaseApi):
    ...
    def game_item_get_item_prices(
        ...
        return self._game_item_get_item_prices_oapg(
