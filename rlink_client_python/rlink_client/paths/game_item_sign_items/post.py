...
request_query_crc = api_client.QueryParameter(
    name="crc",
    style=api_client.ParameterStyle.FORM,
    schema=CrcSchema,
    required=True,
...
class GameItemSignItem(BaseApi):
    ...
    def game_item_sign_item(
        ...
        return self._game_item_sign_item_oapg(
