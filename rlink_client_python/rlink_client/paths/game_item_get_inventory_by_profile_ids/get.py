...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_item_get_inventory_by_profile_ids_oapg(
        self,
...
class GameItemGetInventoryByProfileIds(BaseApi):
    ...
    def game_item_get_inventory_by_profile_ids(
        ...
        return self._game_item_get_inventory_by_profile_ids_oapg(
