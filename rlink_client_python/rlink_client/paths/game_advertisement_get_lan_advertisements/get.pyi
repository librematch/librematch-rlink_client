...
LanServerGuidsSchema = schemas.StrSchema
...
request_query_lan_server_guids = api_client.QueryParameter(
    name="lanServerGuids",
    style=api_client.ParameterStyle.FORM,
    schema=LanServerGuidsSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _game_advertisement_get_lan_advertisements_oapg(
        ...
        for parameter in (
            ...
            request_query_lan_server_guids,
...
class GameAdvertisementGetLanAdvertisements(BaseApi):
    ...
    def game_advertisement_get_lan_advertisements(
        ...
        return self._game_advertisement_get_lan_advertisements_oapg(
