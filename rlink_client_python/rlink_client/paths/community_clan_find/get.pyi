...
JoinPoliciesSchema = schemas.IntSchema
...
request_query_join_policies = api_client.QueryParameter(
    name="joinPolicies",
    style=api_client.ParameterStyle.FORM,
    schema=JoinPoliciesSchema,
    required=True,
    explode=True,
)
...
class CommunityClanFind(BaseApi):
    ...
    def community_clan_find(
        ...
        return self._community_clan_find_oapg(
