...
class BaseApi(api_client.Api):
    @typing.overload
    def _community_get_available_community_events_oapg(
        self,
...
class CommunityGetAvailableCommunityEvents(BaseApi):
    ...
    def community_get_available_community_events(
        ...
        return self._community_get_available_community_events_oapg(
