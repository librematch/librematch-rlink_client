...
WithPartySessionIDSchema = schemas.IntSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'withPartySessionID': typing.Union[WithPartySessionIDSchema, decimal.Decimal, int, ],
    }
)
...
request_query_with_party_session_id = api_client.QueryParameter(
    name="withPartySessionID",
    style=api_client.ParameterStyle.FORM,
    schema=WithPartySessionIDSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_advertisement_start_observing_oapg(
        self,
    ...
    def _game_advertisement_start_observing_oapg(
        ...
        for parameter in (
            ...
            request_query_with_party_session_id,
        ):
...
class GameAdvertisementStartObserving(BaseApi):
    ...
    def game_advertisement_start_observing(
        ...
        return self._game_advertisement_start_observing_oapg(
