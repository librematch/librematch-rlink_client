...
request_query_profileids = api_client.QueryParameter(
    name="profileids",
    style=api_client.ParameterStyle.FORM,
...
class GameLeaderboardGetStatsForLeaderboardByProfileName(BaseApi):
    ...
    def game_leaderboard_get_stats_for_leaderboard_by_profile_name(
        ...
        return self._game_leaderboard_get_stats_for_leaderboard_by_profile_name_oapg(
