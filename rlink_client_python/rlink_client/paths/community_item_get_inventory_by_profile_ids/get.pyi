...
class BaseApi(api_client.Api):
    @typing.overload
    def _community_get_inventory_by_profile_ids_oapg(
        self,
...
class CommunityGetInventoryByProfileIds(BaseApi):
    ...
    def community_get_inventory_by_profile_ids(
        ...
        return self._community_get_inventory_by_profile_ids_oapg(
