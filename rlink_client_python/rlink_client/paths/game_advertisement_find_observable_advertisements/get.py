...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    "RequestRequiredQueryParams",
    {
        ...
        "observerGroupID": typing.Union[
            ObserverGroupIDSchema,
            decimal.Decimal,
            int,
        ],
        "sortOrder": typing.Union[
            SortOrderSchema,
            decimal.Decimal,
            int,
        ],
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_advertisement_find_observable_advertisements_get_oapg(
        self,
...
class GameAdvertisementFindObservableAdvertisementsGet(BaseApi):
    ...
    def game_advertisement_find_observable_advertisements_get(
        ...
        return self._game_advertisement_find_observable_advertisements_get_oapg(
