...
request_query_sale_type = api_client.QueryParameter(
    name="saleType",
    style=api_client.ParameterStyle.FORM,
    schema=SaleTypeSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_item_get_scheduled_sale_and_items_oapg(
        self,
...
class GameItemGetScheduledSaleAndItems(BaseApi):
    ...
    def game_item_get_scheduled_sale_and_items(
        ...
        return self._game_item_get_scheduled_sale_and_items_oapg(
