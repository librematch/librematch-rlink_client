...
IsNonParticipantsSchema = schemas.IntSchema
...
request_query_is_non_participants = api_client.QueryParameter(
    name="isNonParticipants",
    style=api_client.ParameterStyle.FORM,
    schema=IsNonParticipantsSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _game_party_peer_update_oapg(
        ...
        for parameter in (
            ...
            request_query_is_non_participants,
...
class GamePartyPeerUpdate(BaseApi):
    ...
    def game_party_peer_update(
        ...
        return self._game_party_peer_update_oapg(
