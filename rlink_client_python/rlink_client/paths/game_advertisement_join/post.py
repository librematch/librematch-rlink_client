...
PartySchema = schemas.IntSchema
PasswordSchema = schemas.StrSchema
RaceSchema = schemas.IntSchema
StatgroupSchema = schemas.IntSchema
...
request_query_party = api_client.QueryParameter(
    name="party",
    style=api_client.ParameterStyle.FORM,
    schema=PartySchema,
    required=True,
...
request_query_statgroup = api_client.QueryParameter(
    name="statgroup",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_advertisement_join_oapg(
        self,
...
class GameAdvertisementJoin(BaseApi):
    ...
    def game_advertisement_join(
        ...
        return self._game_advertisement_join_oapg(
