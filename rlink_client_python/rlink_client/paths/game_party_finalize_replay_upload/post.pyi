...
ErrorStringSchema = schemas.StrSchema
FinalizeResultSchema = schemas.IntSchema
IsSinglePlayerSchema = schemas.IntSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'errorString': typing.Union[ErrorStringSchema, str, ],
        'finalizeResult': typing.Union[FinalizeResultSchema, decimal.Decimal, int, ],
        'isSinglePlayer': typing.Union[IsSinglePlayerSchema, decimal.Decimal, int, ],
...
request_query_error_string = api_client.QueryParameter(
    name="errorString",
    style=api_client.ParameterStyle.FORM,
    schema=ErrorStringSchema,
    required=True,
    explode=True,
)
request_query_finalize_result = api_client.QueryParameter(
    name="finalizeResult",
    style=api_client.ParameterStyle.FORM,
...
request_query_is_single_player = api_client.QueryParameter(
    name="isSinglePlayer",
    style=api_client.ParameterStyle.FORM,
    schema=IsSinglePlayerSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_party_finalize_replay_upload_oapg(
        self,
    ...
    def _game_party_finalize_replay_upload_oapg(
        ...
        for parameter in (
            ...
            request_query_error_string,
            request_query_finalize_result,
            request_query_is_single_player,
...
class GamePartyFinalizeReplayUpload(BaseApi):
    ...
    def game_party_finalize_replay_upload(
        ...
        return self._game_party_finalize_replay_upload_oapg(
