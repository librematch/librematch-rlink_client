...
ResultSchema = schemas.IntSchema
ResultCodeSchema = schemas.IntSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'callNum': typing.Union[CallNumSchema, decimal.Decimal, int, ],
        'lastCallTime': typing.Union[LastCallTimeSchema, str, ],
        'matchID': typing.Union[MatchIDSchema, decimal.Decimal, int, ],
        'result': typing.Union[ResultSchema, decimal.Decimal, int, ],
        'resultCode': typing.Union[ResultCodeSchema, decimal.Decimal, int, ],
    }
)
...
request_query_result_code = api_client.QueryParameter(
    name="resultCode",
    style=api_client.ParameterStyle.FORM,
    schema=ResultCodeSchema,
    required=True,
    explode=True,
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_automatch2_update_status_oapg(
        self,
...
class GameAutomatch2UpdateStatus(BaseApi):
    ...
    def game_automatch2_update_status(
        ...
        return self._game_automatch2_update_status_oapg(
