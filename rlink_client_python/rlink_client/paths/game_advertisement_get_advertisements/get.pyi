...
request_query_match_ids = api_client.QueryParameter(
    name="match_ids",
    style=api_client.ParameterStyle.FORM,
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_advertisement_get_advertisements_oapg(
        self,
...
class GameAdvertisementGetAdvertisements(BaseApi):
    ...
    def game_advertisement_get_advertisements(
        ...
        return self._game_advertisement_get_advertisements_oapg(
