...
request_query_presence_id = api_client.QueryParameter(
    name="presence_id",
    style=api_client.ParameterStyle.FORM,
    schema=PresenceIdSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_relationship_set_presence_oapg(
        self,
...
class GameRelationshipSetPresence(BaseApi):
    ...
    def game_relationship_set_presence(
        ...
        return self._game_relationship_set_presence_oapg(
