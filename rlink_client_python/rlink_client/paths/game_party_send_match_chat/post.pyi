...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'broadcast': typing.Union[BroadcastSchema, decimal.Decimal, int, ],
        'callNum': typing.Union[CallNumSchema, decimal.Decimal, int, ],
        'from_profile_id': typing.Union[FromProfileIdSchema, decimal.Decimal, int, ],
        ...
        'messageTypeID': typing.Union[MessageTypeIDSchema, decimal.Decimal, int, ],
        'to_profile_id': typing.Union[ToProfileIdSchema, decimal.Decimal, int, ],
    }
)
