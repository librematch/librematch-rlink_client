...
request_query_statsids = api_client.QueryParameter(
    name="statsids",
    style=api_client.ParameterStyle.FORM,
    schema=StatsidsSchema,
    required=True,
    explode=True,
)
_auth = [
...
class BaseApi(api_client.Api):
    @typing.overload
    def _game_leaderboard_get_party_stat_oapg(
        self,
...
class GameLeaderboardGetPartyStat(BaseApi):
    ...
    def game_leaderboard_get_party_stat(
        ...
        return self._game_leaderboard_get_party_stat_oapg(
