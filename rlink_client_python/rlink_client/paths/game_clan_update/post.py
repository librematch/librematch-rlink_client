...
ClanListIdSchema = schemas.IntSchema
...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        ...
        'clanList_id': typing.Union[ClanListIdSchema, decimal.Decimal, int, ],
...
request_query_clan_list_id = api_client.QueryParameter(
    name="clanList_id",
    style=api_client.ParameterStyle.FORM,
    schema=ClanListIdSchema,
    required=True,
    explode=True,
)
...
class GameClanUpdate(BaseApi):
    ...
    def game_clan_update(
        ...
        return self._game_clan_update_oapg(
