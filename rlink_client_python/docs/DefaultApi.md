...
> object game_challenge_get_challenges(call_num, last_call_time, signature)
...
try:
    api_response = api_instance.game_challenge_get_challenges(call_num, last_call_time, signature)
    pprint(api_response)
except ApiException as e:
...
> object game_challenge_update_progress_batched(call_num, last_call_time, progress_i_ds, update_amounts)
...
try:
    api_response = api_instance.game_challenge_update_progress_batched(call_num, last_call_time, progress_i_ds, update_amounts)
    pprint(api_response)
except ApiException as e:
...
> object game_chat_delete_offline_message(call_num, last_call_time, message_id)
...
try:
    api_response = api_instance.game_chat_delete_offline_message(call_num, last_call_time, message_id)
    pprint(api_response)
except ApiException as e:
...
> object game_chat_get_chat_channels(call_num, last_call_time)
...
try:
    api_response = api_instance.game_chat_get_chat_channels(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_chat_get_offline_messages(call_num, last_call_time)
...
try:
    api_response = api_instance.game_chat_get_offline_messages(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_apply(call_num, clan_list_name, last_call_time)
...
try:
    api_response = api_instance.game_clan_apply(call_num, clan_list_name, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_create(call_num, chat, cost, demote, description, disband, edit_info, edit_permission, full_name, icon, invite, item_price_id, join_policy, last_call_time, loc_string_id, message_of_the_day, metadata, name, paymentitem, permission_name, promote, rank, remove, tags)
...
try:
    api_response = api_instance.game_clan_create(call_num, chat, cost, demote, description, disband, edit_info, edit_permission, full_name, icon, invite, item_price_id, join_policy, last_call_time, loc_string_id, message_of_the_day, metadata, name, paymentitem, permission_name, promote, rank, remove, tags)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_disband(call_num, last_call_time)
...
try:
    api_response = api_instance.game_clan_disband(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_find(call_num, count, join_policies, last_call_time, name, start, tags)
...
try:
    api_response = api_instance.game_clan_find(call_num, count, join_policies, last_call_time, name, start, tags)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_get_clan(call_num, last_call_time, names)
...
try:
    api_response = api_instance.game_clan_get_clan(call_num, last_call_time, names)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_get_clan_info_full(call_num, last_call_time, name)
...
try:
    api_response = api_instance.game_clan_get_clan_info_full(call_num, last_call_time, name)
    pprint(api_response)
except ApiException as e:
...
> object game_clan_update(call_num, clan_list_id, description, icon, join_policy, last_call_time, message_of_the_day, metadata, tags)
...
try:
    api_response = api_instance.game_clan_update(call_num, clan_list_id, description, icon, join_policy, last_call_time, message_of_the_day, metadata, tags)
    pprint(api_response)
except ApiException as e:
...
> object game_cloud_get_file_url_get(call_num, last_call_time, names)
...
try:
    api_response = api_instance.game_cloud_get_file_url_get(call_num, last_call_time, names)
    pprint(api_response)
except ApiException as e:
...
> object game_cloud_get_file_url_post(call_num, last_call_time, names)
...
try:
    api_response = api_instance.game_cloud_get_file_url_post(call_num, last_call_time, names)
    pprint(api_response)
except ApiException as e:
...
> object game_cloud_get_temp_credentials(call_num, last_call_time, key)
...
try:
    api_response = api_instance.game_cloud_get_temp_credentials(call_num, last_call_time, key)
    pprint(api_response)
except ApiException as e:
...
> object game_community_event_get_available_community_events(call_num, last_call_time)
...
try:
    api_response = api_instance.game_community_event_get_available_community_events(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_community_event_get_event_challenge_progress(call_num, event_id, last_call_time)
...
try:
    api_response = api_instance.game_community_event_get_event_challenge_progress(call_num, event_id, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_community_event_get_event_stats(call_num, event_id, group_type, last_call_time, member_id)
...
try:
    api_response = api_instance.game_community_event_get_event_stats(call_num, event_id, group_type, last_call_time, member_id)
    pprint(api_response)
except ApiException as e:
...
> object game_invitation_cancel_invitation(call_num, gatheringid, inviteeid, last_call_time)
...
try:
    api_response = api_instance.game_invitation_cancel_invitation(call_num, gatheringid, inviteeid, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_invitation_extend_invitation(call_num, gatheringid, gatheringpassword, inviteeid, last_call_time)
...
try:
    api_response = api_instance.game_invitation_extend_invitation(call_num, gatheringid, gatheringpassword, inviteeid, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_detach_items(call_num, item_charges, item_i_ds, item_locations, last_call_time)
...
try:
    api_response = api_instance.game_item_detach_items(call_num, item_charges, item_i_ds, item_locations, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_inventory_by_profile_ids(call_num, last_call_time, profile_i_ds)
...
try:
    api_response = api_instance.game_item_get_inventory_by_profile_ids(call_num, last_call_time, profile_i_ds)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_item_bundle_items_json(call_num, last_call_time, signature)
...
try:
    api_response = api_instance.game_item_get_item_bundle_items_json(call_num, last_call_time, signature)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_item_definitions_json(call_num, last_call_time, signature)
...
try:
    api_response = api_instance.game_item_get_item_definitions_json(call_num, last_call_time, signature)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_item_loadouts(call_num, last_call_time)
...
try:
    api_response = api_instance.game_item_get_item_loadouts(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_item_prices(account_type, call_num, last_call_time, country, currency, sale_version)
...
try:
    api_response = api_instance.game_item_get_item_prices(account_type, call_num, last_call_time, country, currency, sale_version)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_level_rewards_table_json(call_num, last_call_time, signature)
...
try:
    api_response = api_instance.game_item_get_level_rewards_table_json(call_num, last_call_time, signature)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_personalized_sale_items(call_num, last_call_time)
...
try:
    api_response = api_instance.game_item_get_personalized_sale_items(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_get_scheduled_sale_and_items(call_num, last_call_time, sale_type)
...
try:
    api_response = api_instance.game_item_get_scheduled_sale_and_items(call_num, last_call_time, sale_type)
    pprint(api_response)
except ApiException as e:
...
> object game_item_move_charges(call_num, charges, deletes, from_item_i_ds, last_call_time, to_item_i_ds)
...
try:
    api_response = api_instance.game_item_move_charges(call_num, charges, deletes, from_item_i_ds, last_call_time, to_item_i_ds)
    pprint(api_response)
except ApiException as e:
...
> object game_item_move_item(call_num, item_i_ds, item_location_i_ds, last_call_time, pos_i_ds, slot_i_ds)
...
try:
    api_response = api_instance.game_item_move_item(call_num, item_i_ds, item_location_i_ds, last_call_time, pos_i_ds, slot_i_ds)
    pprint(api_response)
except ApiException as e:
...
> object game_item_open_item_pack(call_num, choices, item_instance_id, item_location_id, last_call_time)
...
try:
    api_response = api_instance.game_item_open_item_pack(call_num, choices, item_instance_id, item_location_id, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_sign_item(call_num, crc, last_call_time)
...
try:
    api_response = api_instance.game_item_sign_item(call_num, crc, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_item_update_item_attributes(attribute_keys, attribute_values, call_num, item_instance_ids, last_call_time, xp_gains)
...
try:
    api_response = api_instance.game_item_update_item_attributes(attribute_keys, attribute_values, call_num, item_instance_ids, last_call_time, xp_gains)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_available_leaderboards(call_num, last_call_time)
...
try:
    api_response = api_instance.game_leaderboard_get_available_leaderboards(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_leaderboard(call_num, last_call_time, start, count, leaderboard_id=leaderboard_id, sort_by=sort_by)
...
try:
    api_response = api_instance.game_leaderboard_get_leaderboard(call_num, last_call_time, start, count, leaderboard_id=leaderboard_id, sort_by=sort_by)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_party_stat(call_num, last_call_time, statsids)
...
try:
    api_response = api_instance.game_leaderboard_get_party_stat(call_num, last_call_time, statsids)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_personal_stat(call_num, last_call_time)
...
try:
    api_response = api_instance.game_leaderboard_get_personal_stat(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_recent_match_history_get(call_num, last_call_time, profile_ids)
...
try:
    api_response = api_instance.game_leaderboard_get_recent_match_history_get(call_num, last_call_time, profile_ids)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_recent_match_history_post(call_num, last_call_time, profile_ids)
...
try:
    api_response = api_instance.game_leaderboard_get_recent_match_history_post(call_num, last_call_time, profile_ids)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_recent_match_single_player_history(call_num, last_call_time, profile_ids)
...
try:
    api_response = api_instance.game_leaderboard_get_recent_match_single_player_history(call_num, last_call_time, profile_ids)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_stat_groups_by_profile_ids(call_num, last_call_time, profileids)
...
try:
    api_response = api_instance.game_leaderboard_get_stat_groups_by_profile_ids(call_num, last_call_time, profileids)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_get_stats_for_leaderboard_by_profile_name(call_num, last_call_time, profileids, leaderboard_id=leaderboard_id)
...
try:
    api_response = api_instance.game_leaderboard_get_stats_for_leaderboard_by_profile_name(call_num, last_call_time, profileids, leaderboard_id=leaderboard_id)
    pprint(api_response)
except ApiException as e:
...
> object game_leaderboard_set_avatar_stat_values(avatar_stat_ids, call_num, last_call_time, update_types, values)
...
try:
    api_response = api_instance.game_leaderboard_set_avatar_stat_values(avatar_stat_ids, call_num, last_call_time, update_types, values)
    pprint(api_response)
except ApiException as e:
...
> object game_login_logout(call_num, last_call_time)
...
try:
    api_response = api_instance.game_login_logout(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
configuration = rlink_client.Configuration()
configuration.api_key['auth'] = 'YOUR_API_KEY'
# Uncomment below to setup prefix (e.g. Bearer) for API key, if needed
# configuration.api_key_prefix['auth'] = 'Bearer'
...
> object game_login_read_session(ack, poll_num)
...
try:
    api_response = api_instance.game_login_read_session(ack, poll_num)
    pprint(api_response)
except ApiException as e:
...
> object game_news_get_news(call_num, last_call_time)
...
try:
    api_response = api_instance.game_news_get_news(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_party_create_or_report_single_player(appbincrc, call_num, counters_zip, create_match_key, datacrc, is_complete, item_updates, last_call_time, mapname, match_key, match_type_id, mod_dll_checksum, mod_dll_file, mod_name, mod_version, options, race_ids, results, slot_info, team_i_ds, version_flags, xp_gained)
...
try:
    api_response = api_instance.game_party_create_or_report_single_player(appbincrc, call_num, counters_zip, create_match_key, datacrc, is_complete, item_updates, last_call_time, mapname, match_key, match_type_id, mod_dll_checksum, mod_dll_file, mod_name, mod_version, options, race_ids, results, slot_info, team_i_ds, version_flags, xp_gained)
    pprint(api_response)
except ApiException as e:
...
> object game_party_finalize_replay_upload(call_num, error_string, finalize_result, is_single_player, last_call_time, match_id, size, url)
...
try:
    api_response = api_instance.game_party_finalize_replay_upload(call_num, error_string, finalize_result, is_single_player, last_call_time, match_id, size, url)
    pprint(api_response)
except ApiException as e:
...
> object game_party_peer_add(call_num, last_call_time, match_id, profile_ids, race_ids, stat_group_ids, team_i_ds)
...
try:
    api_response = api_instance.game_party_peer_add(call_num, last_call_time, match_id, profile_ids, race_ids, stat_group_ids, team_i_ds)
    pprint(api_response)
except ApiException as e:
...
> object game_party_peer_update(call_num, is_non_participants, last_call_time, match_id, profile_ids, race_ids, team_i_ds)
...
try:
    api_response = api_instance.game_party_peer_update(call_num, is_non_participants, last_call_time, match_id, profile_ids, race_ids, team_i_ds)
    pprint(api_response)
except ApiException as e:
...
> object game_party_report_match(call_num, check_sums, counters_zip, item_updates, last_call_time, match_id, profile_ids, race_ids, results, simplayer_i_ds, team_i_ds, xp_gained)
...
try:
    api_response = api_instance.game_party_report_match(call_num, check_sums, counters_zip, item_updates, last_call_time, match_id, profile_ids, race_ids, results, simplayer_i_ds, team_i_ds, xp_gained)
    pprint(api_response)
except ApiException as e:
...
> object game_party_send_match_chat(broadcast, call_num, from_profile_id, last_call_time, match_id, message, message_type_id, to_profile_id)
...
try:
    api_response = api_instance.game_party_send_match_chat(broadcast, call_num, from_profile_id, last_call_time, match_id, message, message_type_id, to_profile_id)
    pprint(api_response)
except ApiException as e:
...
> object game_playerreport_report_user(call_num, comment, last_call_time, metadata, report_reason, report_type, reportee_profile_id)
...
try:
    api_response = api_instance.game_playerreport_report_user(call_num, comment, last_call_time, metadata, report_reason, report_type, reportee_profile_id)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_clear_relationship(call_num, last_call_time, relation_type, target_profile_id)
...
try:
    api_response = api_instance.game_relationship_clear_relationship(call_num, last_call_time, relation_type, target_profile_id)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_get_presence_data(call_num, last_call_time)
...
try:
    api_response = api_instance.game_relationship_get_presence_data(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_get_relationships(call_num, last_call_time)
...
try:
    api_response = api_instance.game_relationship_get_relationships(call_num, last_call_time)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_ignore(blocklevel, call_num, last_call_time, relation_type, target_profile_id)
...
try:
    api_response = api_instance.game_relationship_ignore(blocklevel, call_num, last_call_time, relation_type, target_profile_id)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_set_presence(call_num, last_call_time, presence_id)
...
try:
    api_response = api_instance.game_relationship_set_presence(call_num, last_call_time, presence_id)
    pprint(api_response)
except ApiException as e:
...
> object game_relationship_set_presence_property(call_num, last_call_time, presence_property_def_id, value)
...
try:
    api_response = api_instance.game_relationship_set_presence_property(call_num, last_call_time, presence_property_def_id, value)
    pprint(api_response)
except ApiException as e:
